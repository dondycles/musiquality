  ...
  if (data)
    return (
      <div className="w-full flex">
        <div className="flex flex-row-reverse justify-end items-start gap-4 mx-auto">
          <div className="self-stretch flex flex-col gap-4">
            <div>
              <div className="text-sm text-muted-foreground flex items-center gap-2 my-1">
                <ArrangerAvatar
                  className="size-9"
              ...
              <BrandedText useH1 text={data.title} />
              <SheetOGArtistText
                artists={data.original_artist as original_artist}
              />
            </div>
            <div className="mb-0 mt-auto text-sm text-muted-foreground capitalize">
              <p>Other info:</p>
